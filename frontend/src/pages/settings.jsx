...
export default function SettingsPage() {
	...
	return (
  <div className="w-full h-full flex flex-col lg:flex-row items-center justify-center gap-6 px-4 lg:px-0 py-[200px] lg:py-0 pb-24 lg:pb-0 overflow-y-auto lg:overflow-visible">
    {user ? (
      <>
